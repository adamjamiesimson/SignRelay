...
export const metadata: Metadata = { title: "Supported languages", description: "Honest language and vocabulary support for SignBridge." };

export default function LanguagesPage() {
  return <InfoPage eyebrow="Language support" title="Three languages. Three separate model paths." intro="ASL, ISL and CSL are independent languages with different lexicons and grammar. SignBridge never shares a vocabulary by changing a label." sections={[
