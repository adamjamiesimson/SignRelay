...
export const metadata: Metadata = { title: "How it works", description: "The SignBridge camera-to-transcript recognition pipeline." };

export default function HowItWorksPage() {
  return <InfoPage eyebrow="Recognition architecture" title="Movement first, words second." intro="SignBridge analyses a short ordered sequence of hand, face and body landmarks. It never treats one frozen hand pose as a complete language." sections={[
    ...
    { title: "Holistic landmark extraction", body: <p>Three lightweight MediaPipe tasks detect up to two hands, selected facial cues and upper-body pose. Raw frames stay in the browser and are not sent to a SignBridge server.</p> },
    ...
    { title: "Language-specific adapter", body: <p>Every language declares its own vocabulary, input format, sequence length, threshold and decoder. Changing ASL to ISL or CSL does not relabel the same model.</p> },
