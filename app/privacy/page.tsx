...
export default function PrivacyPage() {
  return <InfoPage eyebrow="Privacy by default" title="Your video belongs to you." intro="SignRelay is designed so the normal translation path runs on your device, without sending raw camera frames to a server." sections={[
    { title: "Camera", body: <p>The browser asks for camera permission when you enter the translator. Raw video frames are processed locally and are not uploaded, recorded or retained by SignRelay.</p> },
    ...
    { title: "Biometric information", body: <p>Landmarks are held briefly in memory for recognition and are not stored. SignRelay does not identify people or create face profiles.</p> },
  ]} />;
}
