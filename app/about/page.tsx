...
export const metadata: Metadata = { title: "About", description: "Why SignBridge exists and the principles behind it." };

export default function AboutPage() {
  return <InfoPage eyebrow="About SignBridge" title="A serious foundation for visible communication." intro="SignBridge is an open engineering project exploring real-time, privacy-first sign-language recognition for Deaf and hearing communication." sections={[
